...
namespace Game
{
    public class ComponentGui : Component, IUpdateable, IDrawable
    {
        ...
        public virtual void HandleInput()
        {
            ...
            if (m_cameraButtonWidget.IsClicked || playerInput.SwitchCameraMode /*|| input.IsKeyDownOnce(Engine.Input.Key.V) ��λᵼ�´���ʱ��v�������*/|| input.IsPadButtonDownOnce(Engine.Input.GamePadButton.RightThumb) || input.IsPadButtonDownOnce(Engine.Input.GamePadButton.DPadDown))
            {
